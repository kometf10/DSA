...
namespace OA.Domin.DataFilter
{
    ...
    public static class TypeOperators
    {
        public static Dictionary<FilterOptions, List<Type>> SupportList = new Dictionary<FilterOptions, List<Type>>()
        {
            ...
            { FilterOptions.IsEqualTo, new List<Type>(){ typeof(int), typeof(DateTime), typeof(string), typeof(int?), typeof(DateTime?), typeof(object), typeof(decimal), typeof(decimal?), typeof(bool), typeof(bool?) } },
